    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        ...
        <div className="space-y-5">
            <SheetStructure
              title="Sheet 1: employee"
              columns={['Employee ID', 'Employee Name', 'Gender', 'DOJ', 'Designation', 'Department', 'Store Name', 'Location', 'Employment Status', 'Tenure', 'Reporting Manager', 'Hiring Source', 'HDFC Account', 'HRBP Name', 'Confirmation Status', 'Age', 'Store Details']}
            />
            <SheetStructure
              title="Sheet 2: exit"
      ...
      <div className="bg-blue-50 rounded-xl border border-blue-100 p-5">
        ...
        <ol className="space-y-2 text-sm text-blue-800">
          <li className="flex gap-2"><span className="font-bold w-5 shrink-0">1.</span> Create a Google Sheet with 4 tabs: "employee", "exit", "approved workforce", and "open position"</li>
